                    ...
                    <div class="breadcrumb-content text-center">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb justify-content-center">
                                ...
                                <li class="breadcrumb-item active" aria-current><a href="./room1.jsp">스탠다드</a></li>
                            </ol>
                        </nav>
                    </div>
                </div>
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-12 col-lg-8">
                    ...
                    <div class="post-thumbnail mb-50">
                        <img src="../image/standard.jpg" alt="">
                    </div>
                    <!-- Blog Details Text -->
                    <div class="blog-details-text">
                        <h3>3~16층에 위치한 스탠다드룸은 편안함과 쾌적함이 <br> 인상적인 최상의 휴식 환경을 제공합니다.</h3>
                        ...
                        <p>위치 : 3 ~ 16층 | 전망 : 시티 뷰 | 침대 : 더블, 트윈 | 크기 : 21.7m | 구성 : 침실 1, 욕실 1</p>
                    </div>
                   <!-- Post Author Area -->
                                ...
                                <div class="comment-content d-flex">
                                    ...
                                    <div class="comment-meta">
                                       <table width="400">
                                            ...
                                            <tr><td></td><td>- 무료 생수 2병</td></tr>
                                            <tr><td></td><td>- 무료 유무선 인터넷</td></tr>
                                            <tr><td></td><td>- 개인 금고</td></tr>
                                            <tr><td></td><td>- 유니버셜 어댑터</td></tr>
