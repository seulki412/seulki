...
<body>
		...
		<div class="text-center">
			<a class="btn" href="${pageContext.request.contextPath}/admin/AdminRoomList.ad" >목록</a>
			<a class="btn" href="${pageContext.request.contextPath}/admin/room_add.jsp">추가</a>
			<a class="btn" href="${pageContext.request.contextPath}/admin/AdminRoomEdit.ad?r_id=${room.r_id }" >수정</a>
			<a class="btn" href="${pageContext.request.contextPath}/admin/AdminRoomDelete.ad?r_id=${room.r_id }">삭제</a>
		</div>
		<!--// 버튼 끝 -->
	</div>
</body>
