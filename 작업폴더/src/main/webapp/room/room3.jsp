                    ...
                    <div class="breadcrumb-content text-center">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb justify-content-center">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">프리미어 디럭스</li>
                            </ol>
                        </nav>
                    </div>
                </div>
            ...
            <div class="row justify-content-center">
                        ...
                        <div class="single-widget-area mb-100">
                            <div class="newsletter-form">
                                ...
                                <div>
                                 ...
                                 <a href="../room/room3.jsp" style="color: white;">프리미어ㅏ 디럭스<span class="fa fa-arrow-right"></span></a>                                                                        
                                </div><br>
                                <div>
                ...
                <div class="col-12 col-lg-8">
                    ...
                    <div class="post-thumbnail mb-50">
                        <img src="../image/프리미어디럭스1.jpg" alt="">
                    </div>
                    <!-- Blog Details Text -->
                    <div class="blog-details-text">
                        <h3>고층에 위치한 프리미어 디럭스룸은 미니바가 포함되어 있어 보다 편안하게 이용하실 수 있는 객실입니다.</h3>
                        ...
                        <p>위치 : 19층 | 전망 : 시티 뷰 | 침대 : 더블 | 크기 : 21.7m | 구성 : 침실 1, 욕실 1</p>
                    </div>
                   <!-- Post Author Area -->
                                ...
                                <div class="comment-content d-flex">
                                    ...
                                    <div class="comment-meta">
                                       <table width="500">
                                            ...
                                            <tr>
                                                <td rowspan="20" style="text-align:left;">객실이용</td>                                                
                                                <td></td>
                                            </tr>
                                            <tr><td></td><td> 프리미어 디럭스 서비스</td></tr>
                                            <tr><td></td><td>- 객실 내 미니바 무료 이용</td></tr>
                                            <tr><td></td><td>(면도기,맥주,스낵...)</td></tr>                                           
