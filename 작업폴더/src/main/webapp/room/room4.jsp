                    ...
                    <div class="breadcrumb-content text-center">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb justify-content-center">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">그랜드</li>
                            </ol>
                        </nav>
                    </div>
                </div>
...
<!-- Blog Area Start -->
    <div class="roberto-news-area section-padding-100-0">
        <div class="container">
            <div class="row justify-content-center"> <div class="col-12 col-sm-8 col-md-6 col-lg-4">
                        ...
                        <div class="single-widget-area mb-100">
                            <div class="newsletter-form">
                                ...
                                <div>
                                  ...
                                  <a href="../room/room4.jsp" style="color: white;">그랜드<span class="fa fa-arrow-right"></span></a>                                                                        
                                </div><br>
                ...
                <div class="col-12 col-lg-8">
                    ...
                    <div class="blog-details-text">
                        <h3>23~26층에 위치한 그랜드룸은 심플하고 <br> 모던한 디자인이 돋보이는 넓은 공간을 자랑합니다.</h3>
                        ...
                        <p>위치 : 23 ~ 26층 | 전망 : 시티 뷰 | 침대 : 더블 | 크기 : 50m | 구성 : 침실 1, 라운지룸 1, 욕실 1</p>
                    </div>
                   <!-- Post Author Area -->
                                    ...
                                    <div class="comment-meta">
                                       <table width="500">
                                            ...
                                            <tr><td></td><td>- 2개의 목욕가운</td></tr>
                                         	<tr><td></td><td>엑스트라 베드 1개 추가 33,000원/1박</td></tr>                                        
