            ...
            <div class="row justify-content-center">
                <div class="col-12 col-lg-8">   
                    ...
                    <table style="width: 100%;table-layout: fixed;">                                
                        ...
                        <tr>                                   
                            <div class="col-12 col-lg-6 fadeInUp" data-wow-delay="100ms">
                               이메일 :  <input type="email" name="b_title" class="form-control mb-30" placeholder="이메일을 입력하세요.">
                            </div>                                    
                        </tr>
                        <tr> &nbsp;&nbsp;&nbsp; 문의 내용 :
                            <div class="col-12 fadeInUp" data-wow-delay="100ms">
                                <textarea name="b_content" class="form-control mb-30" style="width: 700px;height: 500px;" placeholder="내용을 입력해주세요"></textarea>
                            </div>
                        </tr>
                        <tr>
                        ...
                        <div class="single-widget-area mb-100">
                            <div class="newsletter-form">
                                ...
                                <div style="background-color:  #524b42;" >
                                    ...
                                    <a href="../inquiry/inquiry.jsp" style="color: white;" >문의하기</a>                                    
                                </div><br>
                                <div>
