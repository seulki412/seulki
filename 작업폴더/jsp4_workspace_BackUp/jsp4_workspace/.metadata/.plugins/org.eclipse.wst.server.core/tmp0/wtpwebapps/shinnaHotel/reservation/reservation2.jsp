...
<%-- 							</c:when> --%>
						<%--게시물이 없는 경우 --%>
		                   <c:otherwise>
		                   	<div class="${check }"></div>
		                      <div style="margin-top: 50px;margin-bottom: 130px;">
		<!--                              <input type="text" class="bye" style="text-align: center;font-size: 30px;color: #524b42;">예약을 원하시는 날짜, 인원을 선택하세요. </p> -->
		                           <input type="text" class="bye" style="border:none;text-align: center;font-size: 30px;color: #524b42;width:1000px;" value="예약 가능한 객실이 없습니다." readonly>
		                       </div>
		                      <div style="margin-top: 50px;margin-bottom: 130px;">
		<!--                              <p style="text-align: center;font-size: 30px;color: #524b42;">예약 가능한 객실이 없습니다.</p> -->
		                           <input type="hidden" class="hi" style="border:none;text-align: center;font-size: 30px;color: #524b42;width:1000px;" value="예약을 원하시는  날짜, 인원을 선택하세요." readonly>
		                       </div>
		                   </c:otherwise>               
		                </c:choose>   
					</div>
	...
	$(document).ready(function(){
		if($("div").hasClass("check")===true){
			
		} else {
			$('.hi').attr("type","text");
			$('.bye').attr("type","hidden");
		}
	});
