...
<body>
    ...
    <section class="welcome-area">
        <div class="welcome-slides owl-carousel">
            ...
            <div class="single-welcome-slide bg-img bg-overlay" style="background-image: url(../image/그랜드1.jpg);" src="../image/그랜드1.jpg">
                <!-- Welcome Content -->
                        ...
                        <div class="row h-100 align-items-center">
                            ...
                            <div class="col-12">
                                <div class="welcome-text text-center">
                                    ...
                                    <a href="#" class="btn roberto-btn btn-2" style="border: 2px solid #f1e3c4;" data-animation="fadeInLeft" data-delay="800ms">예약하기</a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <!-- Single Welcome Slide -->
            <div class="single-welcome-slide bg-img bg-overlay" style="background-image: url(../image/디럭스1.jpg);" src="../image/디럭스1.jpg">
                <!-- Welcome Content -->
                <div class="welcome-content h-100">
                    <div class="container h-100">
                        <div class="row h-100 align-items-center">
                            ...
                            <div class="col-12">
                                <div class="welcome-text text-center">
                                    ...
                                    <a href="#" class="btn roberto-btn btn-2" style="border: 2px solid #f1e3c4;" data-animation="fadeInUp" data-delay="800ms">예약하기</a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <!-- Single Welcome Slide -->
            <div class="single-welcome-slide bg-img bg-overlay" style="background-image: url(../image/스탠다드1.jpg);" data-img-url="../image/스탠다드1.jpg">
                <!-- Welcome Content -->
                <div class="welcome-content h-100">
                    <div class="container h-100">
                        <div class="row h-100 align-items-center">
