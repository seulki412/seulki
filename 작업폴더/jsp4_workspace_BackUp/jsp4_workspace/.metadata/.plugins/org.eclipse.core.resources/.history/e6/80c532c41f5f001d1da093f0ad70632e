	...
	<div class="hotel-search-form-area">
		<div class="container-fluid">
			<div class="hotel-search-form">
				<form
					action="${pageContext.request.contextPath }/reservation/RoomSearch.re"
					method="post">
					<p>날짜, 인원 선택</p>
					<div class="row justify-content-between align-items-end">
						<div class="col-6 col-md-2 col-lg-3">
							<label for="checkIn">체크인</label> <input type="date"
						...
						<div class="col-4 col-md-1">
							<label for="room">객실</label> <select name="room" id="room"
								class="form-control">
						...
						<div class="col-4 col-md-1">
							<label for="adults">성인</label> <select name="adults" id="adults"
								class="form-control">
								<option value="01">01</option>
								<option value="02">02</option>
								<option value="03">03</option>
						...
						<div class="col-4 col-md-2 col-lg-1">
							<label for="children">어린이</label> <select name="children"
						...
						<div class="col-12 col-md-3">
							<button type="submit" class="form-control btn roberto-btn w-100"
								style="background-color: #f1e3c4; color: #524b42;">검색</button>
						</div>
					</div>
				</form>
			</div>
	...
	<c:forEach var="room" items="${RoomList }">
						...
						<div
							...
							<div class="room-thumbnail">
								<img src=${room.r_img } alt="">
							</div>
							<%--Room Content  --%>
							<div class="room-content" style="width: 300px;">
								<h2>${room.r_type }</h2>
								<h4>
									${room.r_price } <span>/ 1박</span>
								</h4>
...
<%-- 										<button type="submit" class="btn roberto-btn w-100"><a href="reservationcheck.jsp?r_price=${room.r_price }&r_type=${room.r_type }&r_id=${room.r_id }&checkin_date=${param.checkin_date}&checkout_date=${param.checkout_date}">예약</a></button> --%>
	...
	<c:otherwise>
        ...
        <p style="text-align: center;font-size: 30px;color: #524b42;">예약을 원하시는 호텔, 날짜, 인원을 선택하세요.</p>
    	</div>
	</c:otherwise>					
	</c:choose>
